...
class ChatWithDataPlugin:
    ...
    def get_SQL_Response(
        ...
        sql_prompt = os.environ.get("AZURE_SQL_SYSTEM_MESSAGE")
        try:
    ...
    def get_answers_from_calltranscripts(
        ...
        query = question
        system_message = os.environ.get("AZURE_CALL_TRANSCRIPT_SYSTEM_MESSAGE")
...
async def stream_openai_text(req: Request) -> StreamingResponse:
    ...
    system_message = os.environ.get("AZURE_OPENAI_STREAM_TEXT_SYSTEM_MESSAGE")
